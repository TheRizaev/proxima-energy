      ...
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Инжиниринг и <span className="text-primary">Собственное производство</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-fr">
          ...
          <div 
            ref={addToBentoRef}
            className="md:col-span-2 bg-primary border border-primary/50 rounded-2xl p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 overflow-hidden relative"
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="text-2xl font-bold text-bgDark">EPC подрядчик полного цикла</h3>
              </div>
              <p className="text-bgDark/80 max-w-lg font-medium">
